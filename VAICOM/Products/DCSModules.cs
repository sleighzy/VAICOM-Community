    ...
    namespace Products
    {
        ...
        public static class DCSmodules
        {
            ...
            public static Dictionary<string, DCSmodule> LookupTable = new Dictionary<string, DCSmodule>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                {"MiG-29 Fulcrum" , new DCSmodule() { Id ="MiG-29 Fulcrum",Name = "MiG-29",  Alias = "Fulcrum",      ProOnly = true,  IsFC = false,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Mig Twenty Nine"} },
